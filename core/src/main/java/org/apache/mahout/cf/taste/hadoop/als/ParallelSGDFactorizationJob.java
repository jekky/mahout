...
/**
 * <p>MapReduce implementation of the parallel SGD factorization algorithm described in
 *
...
public class ParallelSGDFactorizationJob extends AbstractJob {
  ...
  private static final Logger log = LoggerFactory.getLogger(ParallelSGDFactorizationJob.class);

  static final String NUM_FEATURES = ParallelSGDFactorizationJob.class.getName() + ".numFeatures";
  static final String LAMBDA = ParallelSGDFactorizationJob.class.getName() + ".lambda";
  static final String ALPHA = ParallelSGDFactorizationJob.class.getName() + ".alpha";
  static final String NUM_ENTITIES = ParallelSGDFactorizationJob.class.getName() + ".numEntities";

  static final String USES_LONG_IDS = ParallelSGDFactorizationJob.class.getName() + ".usesLongIDs";
  static final String TOKEN_POS = ParallelSGDFactorizationJob.class.getName() + ".tokenPos";
